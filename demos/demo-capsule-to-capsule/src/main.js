(function () {
  ...
  drawCapsule(context2d, greenCapsule);
  drawCapsule(context2d, blueCapsule);

  textBool[0].innerText = "Red Capsule to Green Capsule: " + collisionManager.boolCapsuleToCapsule(greenCapsule, redCapsule);
  textBool[1].innerText = "Green Capsule to Blue Capsule: " + collisionManager.boolCapsuleToCapsule(greenCapsule, blueCapsule);
